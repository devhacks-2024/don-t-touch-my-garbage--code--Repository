...
const users = [
    new PeopleObj(1, 'path/to/image2.jpg', 29, 'Female', 'Enthusiastic about mobile development and UX design.',"password"),
    new PeopleObj(2, 'path/to/image2.jpg', 28, 'Female', 'Enthusiastic about mobile development and UX design.',"password"),
    new PeopleObj(3, 'path/to/image3.jpg', 32, 'Male', 'Full-stack developer with a love for JavaScript and Python.',"password"),
    new PeopleObj(4, 'path/to/image4.jpg', 29, 'Non-binary', 'AI enthusiast and data scientist.',"password"),
    new PeopleObj(5, 'path/to/image5.jpg', 35, 'Female', 'DevOps engineer focusing on cloud infrastructure and security.',"password"),
    new PeopleObj(6, 'path/to/image.jpg', 30, 'Female', 'Software engineer with a passion for coding challenges.', "password"),
    new PeopleObj(7, 'path/to/image.jpg', 31, 'Male', 'Software engineer with a passion for coding challenges.', "password"),
    new PeopleObj(8, 'path/to/image.jpg', 32, 'Male', 'Software engineer with a passion for coding challenges.', "password"),
